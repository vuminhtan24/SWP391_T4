<%-- 
    Document   : updateperfume.jsp
    Created on : May 27, 2025, 10:19:46 AM
    Author     : Admin
--%>
                ...
                <div class="row vh-100 bg-light rounded align-items-center justify-content-center mx-0">
                    <div class="col-md-6 text-center">
                        <div class="content">
                            ...
                            <form action="update_flower?id=${item.rawid}" method="post">
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="row g-3 align-items-center">
                                            <div class="col-md-4">
                                                ...
                                                <input type="number" name="quantity" class="form-control" min="0" value="${item.rawQuantity}" readonly>
                                            </div>
                                            <div class="col-md-4">
                                                <label for="price" class="form-label">Unit Price ($)</label>
                                                <input type="number" name="price" class="form-control" min="0" value="${item.unitPrice}" required>
                                            </div>
                                            <div class="col-md-4">
                                                 <label for="price" class="form-label">Import Price ($)</label>
                                                 <input type="number" name="price" class="form-control" min="0" value="${item.importPrice}" required>
                                            </div>
                                        </div>
                                        <div class="row g-3 mt-3">
                                            <div class="col-md-6">
                                                ...
                                                <select id="warehouseId" name="warehouseId" class="form-select" required>
                                                    <option value="${item.warehouseId}">${item.warehosueName}</option>
                                                    <c:forEach items="${sessionScope.listC}" var="c">
                                                        <c:if test="${c.id != item.warehouseId}">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="date" class="form-control" name="expirationDate" value="" readonly>
                                            </div>
                                        </div>
