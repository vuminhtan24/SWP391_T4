        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="${pageContext.request.contextPath}/DashMin/admin" class="navbar-brand mx-4 mb-3">
                    ...
                    <div class="d-flex align-items-center ms-4 mb-4">
                        <div class="position-relative">
                            <img class="rounded-circle" src="6ZtLhYqvE7_1628592954.jpg" alt="" style="width: 40px; height: 40px;">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="${pageContext.request.contextPath}/repairOrders" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Repair Orders</a>
                    <div class="nav-item dropdown">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light rounded h-100 p-4">
                    <h6 class="mb-4">Bouquet Repair Orders List</h6>
                    ...
                    <c:choose>
                        <c:when test="${empty repairOrders}">
                            <p>Don't have any flower bouquet repair requests.</p>
                        </c:when>
                        <c:otherwise>
                                    ...
                                    <tbody>
                                        <c:forEach var="order" items="${repairOrders}">
                                            <tr>
                                                ...
                                                <td>${order.status}</td>
                                                <td>
                                                    <form action="${pageContext.request.contextPath}/repairOrders" method="post" class="d-inline">
                                                        <input type="hidden" name="repairId" value="${order.repairId}">
                                                        <input type="hidden" name="bouquetId" value="${order.bouquetId}">
                                                        <input type="hidden" name="oldBatchId" value="${order.batchId}">
                                                        <input type="text" name="newBatchId" placeholder="Enter new batch_id" required class="form-control d-inline-block w-auto">
