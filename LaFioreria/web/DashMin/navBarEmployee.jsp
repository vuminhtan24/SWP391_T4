<%-- 
    Document   : navBarEmployee
    Created on : Jul 22, 2025, 9:24:01 AM
    Author     : LAPTOP
--%>
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                        <c:choose>
                            ...
                            <c:otherwise>
                                <c:forEach var="notification" items="${notifications}" varStatus="loop" end="4">
                                ...
                                <a href="${pageContext.request.contextPath}/ExpiredContractsServlet" class="dropdown-item text-center">View all notifications</a>
                            </c:otherwise>
                        </c:choose>
                    </div>
                </div>
