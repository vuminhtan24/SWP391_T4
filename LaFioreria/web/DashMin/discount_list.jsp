                        ...
                        <c:if test="${not empty editDiscount}">
                            <div class="card mb-4">
                                <div class="card-header bg-warning text-white">
                                    <h5 class="mb-0">Edit Discount Code: ${editDiscount.code}</h5>
                                </div>
                                <div class="card-body">
                                    <form action="updateDiscount" method="post">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select name="type" class="form-select">
                                                    <option value="PERCENT" ${editDiscount.type == 'PERCENT' ? 'selected' : ''}>Percent</option>
                                                    <option value="AMOUNT" ${editDiscount.type == 'AMOUNT' ? 'selected' : ''}>Fixed Amount</option>
                                                </select>
                                            </div>
                                            <div class="col-md-6">
                                                <label>Value</label>
                                        ...
                                        <%-- START: Success Message Block --%>
                                        <c:if test="${not empty sessionScope.message}">
                                            <div class="alert alert-success alert-dismissible fade show" role="alert">
                                                ${sessionScope.message}
                                                <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                                            </div>
                                            <%-- Important: Remove message from session after display --%>
                                            <% session.removeAttribute("message"); %>
                                        </c:if>
                                        <%-- END: Success Message Block --%>
                                        <div class="mt-4">
                                            <button type="submit" class="btn btn-success">Save Changes</button>
                                            <a href="/LaFioreria/discount" class="btn btn-secondary">Cancel</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
