            ...
            <div class="sidebar pe-4 pb-3">
                <nav class="navbar bg-light navbar-light">
                    ...
                    <div class="navbar-nav w-100">
                        <a href="${pageContext.request.contextPath}/DashMin/admin.jsp" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                        ...
                        <a href="${pageContext.request.contextPath}/DashMin/rawflower" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>RawFlower</a>                    
                        <div class="nav-item dropdown">
