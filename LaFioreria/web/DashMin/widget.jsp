<%-- 
    Document   : widget
    Created on : May 19, 2025, 2:42:40 PM
    Author     : ADMIN
--%>
            ...
            <div class="sidebar pe-4 pb-3">
                <nav class="navbar bg-light navbar-light">
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <a href="${pageContext.request.contextPath}/DashMin/widget.jsp" class="nav-item nav-link active"><i class="fa fa-th me-2"></i>Widgets</a>
