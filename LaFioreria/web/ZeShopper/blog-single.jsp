<%-- 
    ...
    Created on : May 19, 2025, 8:43:13 AM
    Author     : ADMIN
--%>
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="${pageContext.request.contextPath}/home"><img src="${pageContext.request.contextPath}/ZeShopper/images/home/logo1.jsp" alt="" /></a>
						</div>
							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#" class="active">Blog<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
										...
										<li><a href="${pageContext.request.contextPath}/ZeShopper/blog-single.jsp" class="active">Blog Single</a></li>
                                    </ul>
                                </li> 
			...
			<div class="row">
				...
				<div class="col-sm-9">
					...
					<div class="socials-share">
						<a href=""><img src="${pageContext.request.contextPath}/ZeShopper/images/blog/socials.png" alt=""></a>
					</div><!--/socials-share-->

					<div class="media commnets">
						<a class="pull-left" href="#">
							<img class="media-object" src="${pageContext.request.contextPath}/ZeShopper/images/blog/man-one.jpg" alt="">
						</a>
					...
					<div class="response-area">
						...
						<ul class="media-list">
							<li class="media">
								...
								<a class="pull-left" href="#">
									<img class="media-object" src="${pageContext.request.contextPath}/ZeShopper/images/blog/man-two.jpg" alt="">
								</a>
								<div class="media-body">
							...
							<li class="media second-media">
								<a class="pull-left" href="#">
									<img class="media-object" src="${pageContext.request.contextPath}/ZeShopper/images/blog/man-three.jpg" alt="">
								</a>
								<div class="media-body">
									<ul class="sinlge-post-meta">
										<li><i class="fa fa-user"></i>Janis Gallagher</li>
							...
							<li class="media">
								<a class="pull-left" href="#">
									<img class="media-object" src="${pageContext.request.contextPath}/ZeShopper/images/blog/man-four.jpg" alt="">
								</a>
								<div class="media-body">
									<ul class="sinlge-post-meta">
										<li><i class="fa fa-user"></i>Janis Gallagher</li>
