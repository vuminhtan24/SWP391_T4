...
INSERT INTO `bouquet` VALUES (1,'Romantic Rose','A bouquet of fresh roses',1,250000,1250000),(2,'Spring Delight','Colorful tulips and lilies',2,353000,1765000),(3,'Sunny Love','Sunflowers and roses for a cheerful gift',5,110000,550000),(4,'Rose Radiance','A vibrant bouquet of fresh red roses symbolizing love and passion.',1,500000,2500000),(5,'Lily Light','Elegant lilies arranged to brighten up any occasion.',2,130000,650000),(6,'Sunflower Smile','Cheerful sunflowers to bring joy and energy.',3,120000,600000),(7,'Tulip Treasure','An exotic bouquet of multicolored tulips.',4,500000,2500000),(8,'Orchid Elegance','Luxurious white orchids in an elegant arrangement.',5,1200000,6000000),(9,'Sun Dreams','A cheerful bouquet featuring sunflowers and baby\'s breath.',1,345000,1725000),(10,'Peony Passion','Romantic peonies paired with soft accents.',2,700000,3500000),(11,'Carnation Bliss','Elegant mix of carnations and daisies.',2,720000,3600000),(12,'Hydrangea Harmony','Soothing tones with hydrangeas and baby\'s breath.',3,450000,2250000),(27,'noo','123120301230102 3012 30123 1023 012301230123 12 31 23 1 231 0230',1,60000,300000);
...
INSERT INTO `bouquet_raw` VALUES (1,1,10),(2,1,1),(2,2,5),(2,3,3),(3,1,2),(3,5,4),(4,1,20),(5,3,5),(6,5,8),(7,2,10),(8,4,15),(9,5,3),(9,10,10),(10,7,7),(11,6,12),(11,8,10),(12,9,3),(12,10,10),(27,8,1);
...
INSERT INTO `cartdetails` VALUES (1,7,1,2),(2,7,3,1),(3,8,2,4),(4,8,1,1),(10,12,5,1);
...
INSERT INTO `flower_batch` VALUES (1,1,500,15000,'2025-07-01','2025-08-31',NULL,1),(2,2,300,35000,'2025-07-01','2025-08-25',NULL,1),(3,3,200,16000,'2025-07-01','2025-08-28',NULL,1),(4,4,100,55000,'2025-07-01','2025-08-30',NULL,2),(5,5,150,10000,'2025-07-01','2025-08-29',NULL,2),(6,6,400,7000,'2025-07-01','2025-07-05',NULL,1),(7,7,250,70000,'2025-07-01','2025-07-10',NULL,1),(8,8,350,40000,'2025-07-01','2025-07-03',NULL,2),(9,9,200,35000,'2025-07-01','2025-07-07',NULL,2),(10,10,500,20000,'2025-07-01','2025-07-08',NULL,1),(11,11,0,30000,'2025-07-01','2025-07-06',0,1);
...
INSERT INTO `flower_type` VALUES (1,'Rose','https://flooers.co.uk/wp-content/uploads/2023/02/3CC66EEC-0B20-4AC4-B2FD-E82A4734E596.jpeg',_binary ''),(2,'Tulip','https://mobileimages.lowes.com/productimages/06095299-423a-422e-af57-7b50460097b3/02989030.jpg?size=pdhz',_binary ''),(3,'Lily','https://flowerexplosion.com/cdn/shop/products/white-asiatic-lily_900x.jpg?v=1658372981',_binary ''),(4,'Orchid','https://ahsam.imgix.net/assets/img/dictionary/orchid-blue-wall.jpg?w=450&dpr=2',_binary ''),(5,'Sunflower','https://www.highmowingseeds.com/media/catalog/product/cache/95cbc1bb565f689da055dd93b41e1c28/7/1/7100-1.jpg',_binary ''),(6,'Daisy','https://www.cumbriawildflowers.co.uk/image/data/products/Leucanthemum-vulgare2.jpg',_binary ''),(7,'Peony','https://bizweb.dktcdn.net/thumb/grande/100/442/027/products/thie-t-ke-chu-a-co-te-n-1-png-dd9b3fd9-4e4c-4bdf-ba60-136fbbe6fc55.jpg?v=1713328120593',_binary ''),(8,'Carnation','https://premierseedsdirect.com/wp-content/uploads/2017/02/Carnation-Scarlet-Red-2-scaled.jpg',_binary ''),(9,'Hydrangea','https://ecolafa.com/wp-content/uploads/2021/10/hoa-cam-tu-cau.png',_binary ''),(10,'Baby\'s Breath','https://www.bloombybunches.ca/cdn/shop/files/babys-breath-gypsophila-white-million-star-diy-wedding-events-720.webp?v=1740864684',_binary ''),(11,'Lavender','https://charsawfarms.com/cdn/shop/files/PurpleBouquetlavender2.jpg?v=1710207668&width=1946',_binary '');
...
INSERT INTO `order` VALUES (1,'2025-08-10',7,'250000',1,11,NULL,NULL,NULL),(2,'2025-08-11',8,'110000',4,11,'/uploads/8f95c217ba2d2346b499f9772ec15d3a.jpg',NULL,NULL),(4,'2025-06-16',12,'1208000',1,NULL,NULL,NULL,NULL);
...
-- Dump completed on 2025-06-22 19:30:48
