...
/**
 * Servlet for managing and displaying the list of orders.
 * Handles search, filter, sort, and pagination for orders.
 * @author VU MINH TAN
 */
...
public class OrderListServlet extends HttpServlet {
     ...
     * This method is generally not used directly for this servlet's logic,
     * as doGet and doPost are overridden.
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            // This part is typically for a simple text response, not for forwarding to JSP.
            // It's often left as a placeholder or removed if doGet/doPost handle everything.
     ...
     * Retrieves and displays a paginated, searchable, sortable list of orders.
     * @param request servlet request
     * @param response servlet response
     * @throws ServletException if a servlet-specific error occurs
     * @throws IOException if an I/O error occurs
     ...
     * Delegates to doGet for simplicity in this management interface.
     * @param request servlet request
     * @param response servlet response
     * @throws ServletException if a servlet-specific error occurs
     * @throws IOException if an I/O error occurs
    ...
    public String getServletInfo() {
        return "Servlet for managing and displaying orders.";
    }
}
